                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                <div class="text-center account-logo-box main-bg1">
...
<a href="forgot-password.php" class="text1"><i class="mdi mdi-lock"></i> Forgot your password?</a>
<hr>
                                        <div class="form-group">
                                            <div class="col-xs-12">
...
<a href="../index.php"  class="text1"><i class="mdi mdi-home"></i> Back Home</a>
                                </div>
                            </div>
                            <!-- end card-box-->
