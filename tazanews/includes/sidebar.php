  <div class="col-md-4">
        ...
        <input type="text" name="searchtitle" class="form-control" placeholder="Search for..." required>
                <span class="input-group-btn">
                  <button class="btn btn-secondary main-bg1" type="submit">Go!</button>
                </span>
              </form>
              </div>
            </div>
...
?>
                    ...
                    <li>
                      <a href="category.php?catid=<?php echo htmlentities($row['id'])?>"  class="text1"><?php echo htmlentities($row['CategoryName']);?></a>
                    </li>
<?php } ?>
                  </ul>
                </div>
...
?>
  ...
  <li>
                      <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="text1"><?php echo htmlentities($row['posttitle']);?></a>
                    </li>
            <?php } ?>
          </ul>
            </div>
...
?>
  ...
  <li>
                      <a href="news-details.php?nid=<?php echo htmlentities($result['pid'])?>"  class="text1"><?php echo htmlentities($result['posttitle']);?></a>
                    </li>
            <?php } ?>
          </ul>
            </div>
